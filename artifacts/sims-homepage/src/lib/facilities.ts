...
export const FACILITIES_PAGE = {
  ...
  subtitle:
    'A practical learning campus in Dehradun — laboratories, hostel living, transport, library resources, and student support designed for healthcare education.',
  metaDescription:
    'Explore campus facilities at Sushila Institute of Medical Sciences (SIMS), Dehradun — laboratories, hostel, transport, library, auditorium, and student support spaces.',
  intro: [
